...
Tarsapi.RedisProxy.prototype.blpop = function(ctx, time, ks) {
    ...
    return this._worker
        .tars_invoke('blpop', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.brpop = function(ctx, time, ks) {
    ...
    return this._worker
        .tars_invoke('brpop', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.expire = function(ctx, k, exp) {
    ...
    return this._worker
        .tars_invoke('expire', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.get = function(ctx, k) {
    ...
    return this._worker
        .tars_invoke('get', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.getRange = function(ctx, k, startOffset, endOffset) {
    ...
    return this._worker
        .tars_invoke('getRange', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.hgetAll = function(ctx, k) {
    ...
    return this._worker
        .tars_invoke('hgetAll', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.hmset = function(ctx, k, hash) {
    ...
    return this._worker
        .tars_invoke('hmset', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.llen = function(ctx, k) {
    ...
    return this._worker
        .tars_invoke('llen', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.lpop = function(ctx, k) {
    ...
    return this._worker
        .tars_invoke('lpop', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.lpush = function(ctx, k, element) {
    ...
    return this._worker
        .tars_invoke('lpush', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.rpop = function(ctx, k) {
    ...
    return this._worker
        .tars_invoke('rpop', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.rpush = function(ctx, k, element) {
    ...
    return this._worker
        .tars_invoke('rpush', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.set = function(ctx, k, v) {
    ...
    return this._worker
        .tars_invoke('set', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.setex = function(ctx, k, v, exp) {
    ...
    return this._worker
        .tars_invoke('setex', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
...
Tarsapi.RedisProxy.prototype.setnx = function(ctx, k, v) {
    ...
    return this._worker
        .tars_invoke('setnx', _encode(), arguments.length != 0 ? arguments[arguments.length - 1] : undefined)
        .then(_decode, _error);
};
