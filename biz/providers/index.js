...
var Tarsapi = require('./ucmsapiProxy.js').Tarsapi;
var http = require('http');

Tars.initialize('./config.conf');
var KVProxy = Tars.stringToProxy(Tarsapi.KVProxy, Tars.configure.get('main.KVServer'));
...
exports.getData = async params => {
    ...
    var docData = {};
    try {
        var docData = await KVProxy.getDocument(parseInt(params.id)).then(success, error); //6361923764438962523
