...
/* eslint-disable */
(function() {
    window.ResumeUpload = (file, options) => {
        console.log(file, options, this);
        const configObj = {};
    ...
    ResumeUpload.prototype = {
        ...
        checkFileSizeAndType: type => {
            ...
            if (type === 0 || type === 2) {
                ...
                if (isInArray(lastName, suffix) === -1) {
                    alert('请选择正确的格式');
        ...
        getUgcTaskInfo: async (type, callback) => {
            /* eslint-disable */
            const _this = this;
            /* eslint-enable */
            if (type === 0 || type === 2) {
        ...
        checkFileCallback: (file, msg, options) => {
            ...
            if (this.type === 0 || this.type === 2) {
                // 视频资源和音频
                if (msg.status.substring(0, 1) === 1 && msg.fileUrl != null) {
                    window.clearInterval(_this.ervalObject);
                    _this.uploading = false;
                    _this.successCallback(msg.fileUrl, _this.file);

                    return;
                } else if (msg.status.substring(0, 1) === 1 && msg.fileUrl == null) {
        ...
        toUpload: msg => {
            ...
            const options = {
                ...
                blockCount: this.blockCount,
                loadstartCallback: this.uploadLoadstartCallback.bond(this),
                loadCallback: this.uploadLoadCallback.bond(this),
                errorCallback: this.uploadErrorCallback.bond(this),
                progressCallback: this.uploadProgressCallback.bond(this),
                abortCallback: this.uploadAbortCallback.bond(this),
                loadendCallback: this.uploadLoadendCallback.bond(this),
            };
        ...
        uploadLoadCallback: (file, msg) => {
            ...
            let param1 = { ...param, ...this.this.oParam };
