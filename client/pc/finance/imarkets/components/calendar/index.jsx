...
class Calender extends PureComponent{
    ...
    dateView(){
        ...
        for(let i = 1; i <= dayLen; i++){
            td.push(
                <td key={ `day_${ i }` } className={ this.isToday(this.state.year, this.state.month, i) ? styles.current : null }>
                    <a>{ i }</a>
                </td>
            );
        }
        ...
        return (
            <div className={ styles.calender }>
                <div className={ styles.tools }>
                    ...
                    <input className={ `${ styles.btn } ${ styles.btn_left }` } type="button" onClick={ this.handleLastMonthClick } />
                    <input className={ `${ styles.btn } ${ styles.btn_right }` } type="button" onClick={ this.handleNextMonthClick } />
                </div>
